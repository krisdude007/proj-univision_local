...
var PrivacyPolicyTemplate = require('views/templates/static-view-templates/privacy-policy');
var TermsOfUseTemplate = require('views/templates/static-view-templates/terms-of-use');
var HelpTemplate = require('views/templates/static-view-templates/help');
var AboutTemplate = require('views/templates/static-view-templates/about');
var HomeView = require('views/home-view');
var ForgotPasswordView = require('views/forgot-password');
var RulesAndRegulationsTemplate = require('views/templates/static-view-templates/rules-and-regulations');
...
var VideoCollectionView = require('views/video-collection-view');
...
module.exports = Backbone.Router.extend({
  ...
  privacyPolicy: function(){
    var staticView = new StaticView({template: PrivacyPolicyTemplate});
    app.layout.content.show(staticView);
  },

  rulesAndRegulations: function(){
    var staticView = new StaticView({template: RulesAndRegulationsTemplate});
    app.layout.content.show(staticView);
  },

  help: function(){
    var staticView = new StaticView({template: HelpTemplate});
    app.layout.content.show(staticView);
  },

  termsOfUse: function(){
    var staticView = new StaticView({template: TermsOfUseTemplate});
    app.layout.content.show(staticView);
  },
  about: function(){
    var staticView = new StaticView({template: AboutTemplate});
    app.layout.content.show(staticView);
  },
  ...
  viewVideos: function(){
    ...
    app.layout.content.show(videoCollectionView);
  }
...
;require.register("min/application-ck", function(exports, require, module) {
require("lib/backbone.validation.for.bootstrap"),require("lib/marionette.brunch"),require("lib/view_helper"),require("lib/backbone.routefilter.min");var App=Backbone.Marionette.Application.extend({root:"",initialize:function(){var e=this;this.on("initialize:after",function(t){return"function"==typeof Object.freeze?Object.freeze(e):void 0}),this.addInitializer(function(t){var n=require("views/AppLayout");e.layout=new n,e.layout.render(),$(function(){FastClick.attach(document.body)});var i=new Snap({element:document.getElementById("content-container"),disable:"right",touchToDrag:!1}),r=function o(e,t,n){return e.addEventListener?e.addEventListener(t,n,!1):e.attachEvent?e.attachEvent("on"+t,n):void 0};r(document.getElementById("open-left"),"click",function(e){e.preventDefault(),"left"==i.state().state?i.close():i.open("left")}),$("#snap-drawer-login-btn, #nav, #snap-drawer-logout-btn").click(function(e){"left"==i.state().state&&i.close()}),function(e,t,n){if(n in t&&t[n]){var i,r=e.location,o=/^(a|html)$/i;e.addEventListener("click",function(e){for(i=e.target;!o.test(i.nodeName);)i=i.parentNode;"href"in i&&(i.href.indexOf("http")||~i.href.indexOf(r.host))&&(e.preventDefault(),r.href=i.href)},!1)}}(document,window.navigator,"standalone")}),this.addInitializer(function(t){var n=require("lib/router");e.router=new n})}});module.exports=new App;
});
...
;require.register("views/templates/static-view-templates/about", function(exports, require, module) {
module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
...
;require.register("views/templates/static-view-templates/help", function(exports, require, module) {
module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<div class=\"fabmob_static-content-container\">\n  <h3>1er Paso</h3>\n  <p>\n    Haz clic en “Grabar” &iexcl;Luz, c&aacute;mara, acci&oacute;n!\n    Ponte frente a la c&aacute;mara, habla claramente, \n    sonr&iacute;e y divi&eacute;rtete grabando tu video.\n  </p>\n  <h3>2do Paso</h3>\n  <p>\n    Describe tu video\n    Agrega el t&iacute;tulo, etiquetas/tags y descripci&oacute;n.\n    No olvides revisarlo.  Si no te gusta, puedes\n    volver a grabarlo.\n  </p>\n  <h3>3er Paso</h3>\n  <p>\n    Despu&eacute;s de hacer clic en enviar, se te pedir&aacute;\n    que te registres si ya no lo has hecho\n  </p>\n  <a href=\"#\">Cont&aacute;ctanos</a>\n</div>";
  });
});

;require.register("views/templates/static-view-templates/privacy-policy", function(exports, require, module) {
module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
...
;require.register("views/templates/static-view-templates/rules-and-regulations", function(exports, require, module) {
module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
...
;require.register("views/templates/static-view-templates/terms-of-use", function(exports, require, module) {
module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<div class=\"fabmob_content-container\">\n\n  <h2 id=\"fabmob_video-upload-success-header\">&iexcl;Felicitaciones!</h2>\n  <p id=\"fabmob_video-upload-success-copy\">\n    &iexcl;Tu video ha sido enviado para su aprobaci&oacute;n! &iexcl;Mientras tanto, puedes seguir participando!\n  </p>  \n\n  <a href=\"/#upload\" class=\"btn btn-block\">Sube Otro Video</a>\n  <a href=\"/#view_videos\" class=\"btn btn-block\">Ver Videos</a>\n\n</div>";
  });
});

;require.register("views/templates/video", function(exports, require, module) {
module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<div class=\"fabmob_video-img-container\">\n  <div class=\"fabmob_video-play-button\"></div>\n  <img src=\"";
  ...
  buffer += escapeExpression(stack1)
    + "\">\n</div>\n<div class=\"fabmob_video-copy-container\">\n  <h5 class=\"fabmob_video-title\">";
  if (stack1 = helpers.videoTitle) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.videoTitle; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "</h5>\n  <p>";
...
;require.register("views/templates/videos", function(exports, require, module) {
module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<div id=\"fabmob_videos-container\">\n</div>\n";
  });
});
...
;require.register("views/video-collection-view", function(exports, require, module) {
var VideoView = require('views/video-view');
var VideoCollectionTemplate = require('views/templates/videos');

module.exports = Backbone.Marionette.CompositeView.extend({
  // Properties
  // --------------------------------------------------------
  itemView: VideoView,
  template: VideoCollectionTemplate,
  itemViewContainer: "#fabmob_videos-container",

  fakeVideoCollectionData: [
    {
      thumbnailUrl: "/images/video-placeholder.jpg",
      videoTitle: "What's your New Year's Resolution?",
      views: 1710000,
      userName: "Gabriel@Illingsworthy",
    },
    {
      thumbnailUrl: "/images/video-placeholder.jpg",
      videoTitle: "Very long title very long title very long title also very long title here a little longer?",
      views: 1710000,
      userName: "Alex@Gomez",
    },
    {
      thumbnailUrl: "/images/video-placeholder.jpg",
      videoTitle: "Super short title",
      views: 171,
      userName: "Bryan#Davila",
    },
    {
      thumbnailUrl: "/images/video-placeholder.jpg",
      videoTitle: "Short Title",
      views: 171,
      userName: "Iliana Quintanilla",
    },
    {
      thumbnailUrl: "/images/video-placeholder.jpg",
      videoTitle: "What's your New Year's Resolution?",
    ...
    {
      thumbnailUrl: "/images/video-placeholder.jpg",
      videoTitle: "What's your New Year's Resolution Very long title here a little longer?",
      views: 171,
      userName: "Alex@Gomez",
    },
    {
  ...
  // --------------------------------------------------------
  initialize: function(){
    // on initialize fetch the require information from api


    // we use fake data here
    this.collection = new Backbone.Collection(this.fakeVideoCollectionData);
  },
...
var VideoTemplate = require('views/templates/video');
...
module.exports = Backbone.Marionette.ItemView.extend({
  ...
  className: 'fabmob_video-container',
