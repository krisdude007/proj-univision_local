...
<div id="content">
    <div class="you">
        ...
        <div class="youContent">
            <h1 style="text-align:left; margin-top: 20px;">Términos de uso</h1>
            <?php if (!$user->terms_accepted): ?>
            <div style="float: left;"><input type="checkbox" id="terms_accept" name="terms_accept" value="1" />He leído y Acepto los Términos de Uso.</div>
            <?php endif; ?>
            <div style="background-color: #fff;padding:20px;width:504px;height:349px;overflow:auto" class="scroll-pane jspScrollable">
