    ...
    <div style="padding-top:20px;margin-bottom:20px;margin-left:auto;margin-right:auto;width:810px;display:inline-block">
        <div style="text-align: center;">
            <?php if(Yii::app()->user->isGuest): ?>
                    ...
                    <br/>
                    <div class="uploadButton" style="margin-left: 130px;"><a href="<?php echo Yii::app()->request->baseurl; ?>/login" style="text-decoration: none;"><b style="color:#fff;">Conéctate</b></a></div>
            <?php else: ?>
