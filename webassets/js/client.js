...
var redirectPage = function() {
        window.parent.location.href = 'https://miembros.univision.com/crm/login?redir=';
                ...
                for (i = 0; i < obj.avg; i++) {
                    ...
                    $('#stars').append(
                        ...
                        'rev': bID
                            ...
                            $('<img></img>').attr({
                        'src': '/webassets/images/play/star_yellow_ff.png'
                    })
                            ))
                }
                for (t = 0; t < 5 - i; t++) {
                    ...
                    $('#stars').append(
                        ...
                        'rev': bID
                            ...
                            $('<img></img>').attr({
                        'src': '/webassets/images/play/star_white_ff.png'
                    })
                            ))
                }
...
$("#recorupClose").on("click", togglePopup);
